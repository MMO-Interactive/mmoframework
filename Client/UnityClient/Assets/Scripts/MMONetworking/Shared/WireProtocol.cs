...
public static class WireProtocol
{
    ...
    {
        if (message is ClientHelloMessage hello)
        {
        ...
        if (message is HelloAcceptedMessage accepted)
        {
        ...
        if (message is AttachAcceptedMessage attachAccepted)
        {
        ...
        if (message is ZoneTransferCommittedMessage transferCommitted)
        {
