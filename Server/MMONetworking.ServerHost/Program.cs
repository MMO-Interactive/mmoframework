...
public static class Program
{
    public static async Task Main()
    {
        ...
        var dashboard = new ManagementDashboardHost(gateway, sessionRegistry, zoneSupervisor, gameplayDefinitions, moderationStore, inventoryStore, craftingStore, progressionStore, combatStore, port: 7080);
